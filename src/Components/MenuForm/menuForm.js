        ...
        <div>
            ...
            <Container className={classes.global} maxWidth="xl">
                ...
                <Grid container direction="column" justify="center" alignItems="center" spacing={5}>
                    ...
                    <Grid item>
                        <TextFieldStylizedOutlined className={classes.textField} label={"Sexe"} variant="outlined"/>
                    </Grid>
                    <Grid item>
                        <TextFieldStylizedOutlined  className={classes.textField}  label={"Budget"} variant="outlined"/>
                    </Grid>
                    <Grid item>
                        <Autocomplete
                            multiple
